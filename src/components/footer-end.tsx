      ...
      <div className='container'>
        <div className='wrapper flex flex-col justify-center items-center'>
          ...
          <div className='ft_top bg-[#131E23] w-[70%] pt-[64px] pb-[64px] rounded-br-[24px] rounded-bl-[24px]'>
            ...
            <form className='form flex justify-center items-center relative w-[80%] mx-auto sm:flex flex-col'>
              <input
                type='tel'
                className='ft_inp w-full  text-[#fff] sm:mb-[30px] md:mb-[64px]'
                placeholder='+998'
              />
              <button
               className='ft_btn text-[12px] font-semibold text-[#ffff] py-[13px] px-[24px] mr-1  right-0 top-[4px]  bg-[#DB9C3A] rounded-[16px] sm:text-[10px] sm:relative md:absolute md:text-[12px]
               '>
                Send request
              </button>
            </form>
